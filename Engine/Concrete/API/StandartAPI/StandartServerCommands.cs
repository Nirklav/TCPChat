...
namespace Engine.Concrete.API.StandartAPI
{
  ...
  class BaseServerCommand
  {
    ...
    protected static bool RoomExists(string roomName, ServerCommandArgs args)
    {
      ...
      if (!result)
      {
        ClientRoomClosedCommand.MessageContent closeRoomContent = new ClientRoomClosedCommand.MessageContent() { Room = new Room(null, roomName) };
      ...
      IServerAPICommand
  {
    public void Run(ServerCommandArgs args)
    {
      ...
      if (!newUserExist)
      {
        Room room = args.API.Server.Rooms[AsyncServer.MainRoomName];
      ...
      IServerAPICommand
  {
    public void Run(ServerCommandArgs args)
    {
      ...
      Room room = args.API.Server.Rooms[receivedContent.RoomName];
      ...
      IServerAPICommand
  {
    public void Run(ServerCommandArgs args)
    {
      ...
      lock (args.API.Server.Rooms)
      {
        ...
        creatingRoom = new Room(args.UserConnection.Info, receivedContent.RoomName);
      ...
      IServerAPICommand
  {
    public void Run(ServerCommandArgs args)
    {
      ...
      Room deletingRoom = args.API.Server.Rooms[receivedContent.RoomName];
      ...
      {
        foreach (User user in deletingRoom.Users)
        {
          ServerConnection userConnection = args.API.Server.Connections.Find((conn) => user.Equals(conn.Info));
      ...
      IServerAPICommand
  {
    public void Run(ServerCommandArgs args)
    {
      ...
      lock (room.Users)
      {
        foreach (User current in room.Users)
        {
      ...
      IServerAPICommand
  {
    ...
    public class MessageContent
    {
      ...
      public User Info { get { return info; } set { info = value; } }
    }
